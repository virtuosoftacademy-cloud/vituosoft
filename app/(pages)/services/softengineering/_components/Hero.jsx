...
export default function Hero(heroData) {
   ...
   return (
        /* Alignment Container: 
           Max-width matching the service cards grid below (1240px).
        */
        <div className="w-full flex justify-center px-6 md:px-10 lg:px-12">
            ...
            >
                {/* Image Section: 
                   Laptop par size optimize kiya hai taake content area balance rahe.
                */}
                <Image
                    width={400} 
                    height={400}
                ...
                <div className="relative z-20">
                    ...
                    <div className="flex justify-center md:justify-start">
                        {/* Button: Original Colors Strictly Preserved */}
                        <Button 
                            asChild
