...
export default function Hero(heroData ) {
    ...
    return (
        /* Alignment Container: 
           Isko max-width 1240px rakha hai taake niche wale grid cards ke edges se match kare.
        */
            ...
            >
                ...
                <div className="relative z-20">
                    ...
                    <div className="flex justify-center md:justify-start">
                        {/* Button Fix: 
                            - Default: Background white, Text primary blue.
                            - Hover: Background primary blue theme, Text white.
                        */}
                        <Button 
                            asChild 
                            className="bg-white text-primary hover:bg-primary hover:text-white 
                                      font-bold capitalize text-sm md:text-base 
                                       px-8 h-12 transition-all duration-300 shadow-xl rounded-lg active:scale-95"
                        >
                            <Link href="/contact">
                                {btnTitle}
                            </Link>
