...
export default function Hero(heroData ) {
    ...
    return (
        /* Alignment Container: 
           Isay 'max-w-[1240px]' rakha hai taake niche wale grid cards ke edges se align ho.
        */
        <div className="w-full flex justify-center px-6 md:px-10 lg:px-12">
            <section
                className="relative w-full max-w-[1240px] py-12 md:py-16 px-8 md:px-16 lg:px-20 
                           ...
                           bg-linear-to-br from-primary to-[#003799] text-white border-white/5"
            >
                {/* Image Section: 
                   Laptop par size ko optimize kiya hai taake content area balance rahe.
                */}
                <Image
                    width={400} 
                    height={400}
                ...
                {/* Content Section: 62% width limit laptop alignment ke liye */}
                <div className="relative z-20">
                    ...
                    <div className="flex justify-center md:justify-start">
                        {/* Button: Original Colors Strictly Preserved (White BG, Primary Text) */}
                        <Button 
                            asChild
                            className="text-sm bg-white text-primary hover:text-accent font-bold capitalize md:text-lg px-8 h-12 transition-all duration-300 shadow-xl rounded-lg active:scale-95"
                        >
                            <Link href="/contact">
                                {btnTitle}
                            </Link>
