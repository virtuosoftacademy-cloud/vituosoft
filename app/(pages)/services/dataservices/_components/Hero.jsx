...
export default function Hero(heroData ) {
    ...
    return (
        /* Alignment Container: 
           'max-w-[1240px]' isliye use kiya hai taake ye niche wale service grid ke edges se 100% match kare.
        */
        <div className="w-full flex justify-center px-6 md:px-10 lg:px-12">
            <section
                className="relative w-full max-w-[1240px] py-12 md:py-16 px-8 md:px-16 lg:px-20 
                           ...
                           bg-linear-to-br from-[#084387] to-[#021021] text-white border-white/5"
            >
                {/* Image Section: 
                   Laptop par size ko optimize kiya gaya hai taake content area clear rahe.
                */}
                <Image
                    width={400} 
                    height={400}
